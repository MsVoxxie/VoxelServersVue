		...
		<div class="crt-overlay min-h-screen flex items-start justify-center">
			<div class="mx-auto w-full max-w-4xl px-4">
				...
				<div id="logo" class="flex flex-row items-center justify-center space-x-1 py-5">
					<img src="/public/img/letters/V.png" class="letter" id="logo-v" />
					<img src="/public/img/letters/O.png" class="letter" id="logo-o" />
					<img src="/public/img/letters/X.png" class="letter" id="logo-x1" />
					<img src="/public/img/letters/X.png" class="letter" id="logo-x2" />
					<img src="/public/img/letters/I.png" class="letter" id="logo-i" />
					<img src="/public/img/letters/E.png" class="letter" id="logo-e" />
				</div>
				<div class="flex flex-col md:flex-row gap-0 w-full">
					...
					<div class="w-40 p-3">
						<div class="box bg-black/70 border-2 border-gray-600 rounded-md shadow-xl p-4 top-4 backdrop-blur-md" id="linksdiv">
							...
							<NuxtLink class="navlink text-[var(--text_col)] hover:underline transition" id="home-link" :to="`/dev`">› Home</NuxtLink><br />
							<NuxtLink class="navlink text-[var(--text_col)] hover:underline transition" id="servers-link" :to="`/servers`">› Servers</NuxtLink><br />
